          ...
          <div className="grid grid-cols-1 lg:grid-cols-3">
            <div className="relative overflow-hidden bg-gradient-to-b from-pink to-white px-4 py-10 sm:px-8 xl:p-12">
              ...
              <dl className="mt-8 space-y-6">
                ...
                <svg className="h-6 w-6 flex-shrink-0 text-gold" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                ...
                <dd className="flex text-sm text-brown">742 Evergreen Terrace Springfield, OR 12345</dd>
              </dl>
            </div>
            ...
            <div className="px-6 pb-10 sm:px-10 lg:col-span-2 xl:p-12">
              ...
              <form action="#" method="POST" className="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                ...
                <div className="sm:col-span-2 sm:flex sm:justify-end">
                  <button type="submit" className="mt-2 inline-flex w-full items-center justify-center rounded-md border border-transparent bg-gradient-to-r from-gold via-white to-gold  px-6 py-3 text-sm font-medium text-brown shadow-sm hover:text-white sm:w-auto">Send</button>
                </div>
              </form>
            </div>
          </div>
